...
# -*- encoding: utf-8 -*-
# stub: jenkins_api_client 1.1.1.pre.2 ruby lib

Gem::Specification.new do |s|
  s.name = "jenkins_api_client"
  s.version = "1.1.1.pre.2"
  ...
  s.files = [
    ...
    "lib/jenkins_api_client/plugin_settings/promoted_builds.rb",
    ...
    "spec/unit_tests/plugin_settings/promoted_builds_spec.rb",
